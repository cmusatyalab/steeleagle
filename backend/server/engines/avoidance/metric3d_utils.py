...
class Metric3DPreprocessor:
    ...
    def apply_canonical_transform(self, depth_map, intrinsic_focal_length=1000.0, target_focal_length=707.0):
        """
...
class Metric3DInference:
    ...
    def predict_depth(self, image, apply_canonical_transform=True):
        ...
        # Run inference
        with torch.no_grad():
            pred_depth, confidence, output_dict = self.model.inference({'input': image_tensor})
