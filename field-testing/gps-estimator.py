...
if __name__ == "__main__":
    ...
    drone_lat = 40.44271299824439
    drone_lon = -79.93926999231915
    north_vec = np.array([0, 1, 0]) # Create a vector pointing due north.
    camera_pitch = -20.000099182128906 # Pitch of the gimbal.
    camera_yaw = 2.320742130279541 * (180/np.pi) # Yaw of the drone.
    camera_elev = 2.731494188308716 # Elevation of the drone.
    target_x_pix = 80 # Location of target in X pixels.
    target_y_pix = 293 # Location of target in Y pixels.
