...
# from tasks.base import Action  # your BaseModel+async base
# from tasks.actions.primitives import SetGimbalPose, SetGlobalPosition, SetVelocity
...
#             set_vel = SetVelocity(0.0, 0.0, self.climb_speed, 0.0)
