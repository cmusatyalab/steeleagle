...
type GetVideoStreamURLRequest struct {
	...
	Resolution    GetVideoStreamURLRequest_Resolution `protobuf:"varint,1,opt,name=resolution,proto3,enum=steeleagle_protocol.v1.services.driver.GetVideoStreamURLRequest_Resolution" json:"resolution,omitempty"` // video stream resolution
