...
type EngineInfo struct {
	...
	// engine location
	Location      EngineLocation `protobuf:"varint,2,opt,name=location,proto3,enum=steeleagle_protocol.v1.services.vehicle.EngineLocation" json:"location,omitempty"`
...
type SetEnginesForTopicRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Topic         Topic                  `protobuf:"varint,1,opt,name=topic,proto3,enum=steeleagle_protocol.v1.services.vehicle.Topic" json:"topic,omitempty"` // topic to forward
