...
const file_steeleagle_protocol_v1_common_proto_rawDesc = "" +
	...
	"\x02_zB\b\n" +
	"\x06_angleB\xf3\x01\n" +
	"\x1acom.steeleagle.protocol.v1B\vCommonProtoP\x01ZNgithub.com/cmusatyalab/steeleagle/api/gen/go/steeleagle/protocol/v1;protocolv1\xa2\x02\x03SPX\xaa\x02\x16Steeleagle.Protocol.V1\xca\x02\x16Steeleagle\\Protocol\\V1\xe2\x02\"Steeleagle\\Protocol\\V1\\GPBMetadata\xea\x02\x18Steeleagle::Protocol::V1b\x06proto3"
...
var file_steeleagle_protocol_v1_common_proto_goTypes = []any{
	(*Pose)(nil),             // 0: steeleagle.protocol.v1.Pose
	(*Velocity)(nil),         // 1: steeleagle.protocol.v1.Velocity
	(*GlobalPosition)(nil),   // 2: steeleagle.protocol.v1.GlobalPosition
	(*RelativePosition)(nil), // 3: steeleagle.protocol.v1.RelativePosition
}
