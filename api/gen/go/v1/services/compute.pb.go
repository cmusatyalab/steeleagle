...
func (EngineLocation) Descriptor() protoreflect.EnumDescriptor {
	return file_v1_services_compute_proto_enumTypes[0].Descriptor()
}

func (EngineLocation) Type() protoreflect.EnumType {
	return &file_v1_services_compute_proto_enumTypes[0]
}
...
func (EngineLocation) EnumDescriptor() ([]byte, []int) {
	return file_v1_services_compute_proto_rawDescGZIP(), []int{0}
}
...
func (Topic) Descriptor() protoreflect.EnumDescriptor {
	return file_v1_services_compute_proto_enumTypes[1].Descriptor()
}

func (Topic) Type() protoreflect.EnumType {
	return &file_v1_services_compute_proto_enumTypes[1]
}
...
func (Topic) EnumDescriptor() ([]byte, []int) {
	return file_v1_services_compute_proto_rawDescGZIP(), []int{1}
}
...
type EngineInfo struct {
	...
	// engine location
	Location      EngineLocation `protobuf:"varint,2,opt,name=location,proto3,enum=steeleagle.api.v1.services.EngineLocation" json:"location,omitempty"`
...
func (x *EngineInfo) Reset() {
	*x = EngineInfo{}
	mi := &file_v1_services_compute_proto_msgTypes[0]
...
type SetEnginesForTopicRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Topic         Topic                  `protobuf:"varint,1,opt,name=topic,proto3,enum=steeleagle.api.v1.services.Topic" json:"topic,omitempty"` // topic to forward
...
func (x *SetEnginesForTopicRequest) Reset() {
	*x = SetEnginesForTopicRequest{}
	mi := &file_v1_services_compute_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *SetEnginesForTopicResponse) Reset() {
	*x = SetEnginesForTopicResponse{}
	mi := &file_v1_services_compute_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetEnginesForTopicResponse) Descriptor() ([]byte, []int) {
	return file_v1_services_compute_proto_rawDescGZIP(), []int{2}
}

var File_v1_services_compute_proto protoreflect.FileDescriptor

const file_v1_services_compute_proto_rawDesc = "" +
	"\n" +
	"\x19v1/services/compute.proto\x12\x1asteeleagle.api.v1.services\"d\n" +
	"\n" +
	"EngineInfo\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12F\n" +
	"\blocation\x18\x02 \x01(\x0e2*.steeleagle.api.v1.services.EngineLocationR\blocation\"\x9a\x01\n" +
...
var (
	file_v1_services_compute_proto_rawDescOnce sync.Once
	file_v1_services_compute_proto_rawDescData []byte
)

func file_v1_services_compute_proto_rawDescGZIP() []byte {
	file_v1_services_compute_proto_rawDescOnce.Do(func() {
		file_v1_services_compute_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_v1_services_compute_proto_rawDesc), len(file_v1_services_compute_proto_rawDesc)))
	})
	return file_v1_services_compute_proto_rawDescData
}

var file_v1_services_compute_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_v1_services_compute_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_v1_services_compute_proto_goTypes = []any{
	(EngineLocation)(0),                // 0: steeleagle.api.v1.services.EngineLocation
	(Topic)(0),                         // 1: steeleagle.api.v1.services.Topic
	(*EngineInfo)(nil),                 // 2: steeleagle.api.v1.services.EngineInfo
	(*SetEnginesForTopicRequest)(nil),  // 3: steeleagle.api.v1.services.SetEnginesForTopicRequest
	(*SetEnginesForTopicResponse)(nil), // 4: steeleagle.api.v1.services.SetEnginesForTopicResponse
}
var file_v1_services_compute_proto_depIdxs = []int32{
	0, // 0: steeleagle.api.v1.services.EngineInfo.location:type_name -> steeleagle.api.v1.services.EngineLocation
	1, // 1: steeleagle.api.v1.services.SetEnginesForTopicRequest.topic:type_name -> steeleagle.api.v1.services.Topic
	2, // 2: steeleagle.api.v1.services.SetEnginesForTopicRequest.datasinks:type_name -> steeleagle.api.v1.services.EngineInfo
	3, // 3: steeleagle.api.v1.services.ComputeService.SetEnginesForTopic:input_type -> steeleagle.api.v1.services.SetEnginesForTopicRequest
	4, // 4: steeleagle.api.v1.services.ComputeService.SetEnginesForTopic:output_type -> steeleagle.api.v1.services.SetEnginesForTopicResponse
...
func init() { file_v1_services_compute_proto_init() }
func file_v1_services_compute_proto_init() {
	if File_v1_services_compute_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_v1_services_compute_proto_rawDesc), len(file_v1_services_compute_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_v1_services_compute_proto_goTypes,
		DependencyIndexes: file_v1_services_compute_proto_depIdxs,
		EnumInfos:         file_v1_services_compute_proto_enumTypes,
		MessageInfos:      file_v1_services_compute_proto_msgTypes,
	}.Build()
	File_v1_services_compute_proto = out.File
	file_v1_services_compute_proto_goTypes = nil
	file_v1_services_compute_proto_depIdxs = nil
}
