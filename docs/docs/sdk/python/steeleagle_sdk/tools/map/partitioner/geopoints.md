...
## <><code class="docs-class">class</code></> GeoPoints

*Inherits from: <code>list</code>*

List[(x, y)] with helpers; (lon,lat) for WGS84 by convention.


### <><code class="docs-method">method</code></> centroid

_Call Type: normal_

### <><code class="docs-method">method</code></> to_polygon

_Call Type: normal_

### <><code class="docs-method">method</code></> to_linestring

_Call Type: normal_

### <><code class="docs-method">method</code></> convert_to_projected

_Call Type: normal_

### <><code class="docs-method">method</code></> inverse_project_from
