...
---
## <><code style={{color: '#b52ee6'}}>class</code></> UploadResponse
...
---
## <><code style={{color: '#b52ee6'}}>class</code></> StartResponse
...
---
## <><code style={{color: '#b52ee6'}}>class</code></> StopResponse
...
---
## <><code style={{color: '#b52ee6'}}>class</code></> NotifyResponse
