...
### Arguments
**<><code style={{color: '#db2146'}}>arg</code></> action** (<code><Link to="/sdk/package/steeleagle_sdk/api/base#class-action">Action</Link></code>) <text>&#8212;</text> input Action to be JSON serialized.
...
<code><Link to="/sdk/package/steeleagle_sdk/api/datatypes/common#class-response">Response</Link></code> <text>&#8212;</text> Python API Response object.
<details>
<summary>View Source</summary>
```python
