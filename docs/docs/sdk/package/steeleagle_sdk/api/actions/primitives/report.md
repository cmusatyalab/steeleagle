...
_Type_: <code><Link to="/sdk/package/steeleagle_sdk/protocol/services/report_service_pb2_grpc#class-reportstub">ReportStub</Link></code>
...
#### Attributes
**<><code style={{color: '#e0a910'}}>attr</code></> report** (<code><Link to="/sdk/package/steeleagle_sdk/api/datatypes/report#class-reportmessage">ReportMessage</Link></code>) <text>&#8212;</text> report data
