...
_Type_: <code><Link to="/sdk/package/steeleagle_sdk/protocol/services/control_service_pb2_grpc#class-controlstub">ControlStub</Link></code>
...
<code><Link to="/sdk/package/steeleagle_sdk/api/datatypes/common#class-response">Response</Link></code> <text>&#8212;</text> response generated by the RPC call.
...
#### Attributes
**<><code style={{color: '#e0a910'}}>attr</code></> velocity** (<code><Link to="/sdk/package/steeleagle_sdk/api/datatypes/common#class-velocity">Velocity</Link></code>) <text>&#8212;</text> target velocity to move towards
...
#### Attributes
**<><code style={{color: '#e0a910'}}>attr</code></> location** (<code><Link to="/sdk/package/steeleagle_sdk/api/datatypes/common#class-location">Location</Link></code>) <text>&#8212;</text> new home location
...
#### Attributes
**<><code style={{color: '#e0a910'}}>attr</code></> location** (<code><Link to="/sdk/package/steeleagle_sdk/api/datatypes/common#class-location">Location</Link></code>) <text>&#8212;</text> target global position

**<><code style={{color: '#e0a910'}}>attr</code></> heading_mode** (<code>Optional[<Link to="/sdk/package/steeleagle_sdk/api/datatypes/control#class-headingmode">HeadingMode</Link>]</code>) <text>&#8212;</text> determines how the vehicle will orient during transit (default: `TO_TARGET`)

**<><code style={{color: '#e0a910'}}>attr</code></> altitude_mode** (<code>Optional[<Link to="/sdk/package/steeleagle_sdk/api/datatypes/control#class-altitudemode">AltitudeMode</Link>]</code>) <text>&#8212;</text> determines how the vehicle will interpret altitude (default: `ABSOLUTE`)

**<><code style={{color: '#e0a910'}}>attr</code></> max_velocity** (<code>Optional[<Link to="/sdk/package/steeleagle_sdk/api/datatypes/common#class-velocity">Velocity</Link>]</code>) <text>&#8212;</text> maximum velocity during transit
...
determined by the manufacturer or hardware settings.
#### Attributes
**<><code style={{color: '#e0a910'}}>attr</code></> position** (<code><Link to="/sdk/package/steeleagle_sdk/api/datatypes/common#class-position">Position</Link></code>) <text>&#8212;</text> target relative position

**<><code style={{color: '#e0a910'}}>attr</code></> max_velocity** (<code>Optional[<Link to="/sdk/package/steeleagle_sdk/api/datatypes/common#class-velocity">Velocity</Link>]</code>) <text>&#8212;</text> maximum velocity during transit

**<><code style={{color: '#e0a910'}}>attr</code></> frame** (<code>Optional[<Link to="/sdk/package/steeleagle_sdk/api/datatypes/control#class-referenceframe">ReferenceFrame</Link>]</code>) <text>&#8212;</text> frame of reference
...
#### Attributes
**<><code style={{color: '#e0a910'}}>attr</code></> velocity** (<code><Link to="/sdk/package/steeleagle_sdk/api/datatypes/common#class-velocity">Velocity</Link></code>) <text>&#8212;</text> target velocity
...
- `HEADING_START` &#8594; turn to face the provided heading in the global position object.
#### Attributes
**<><code style={{color: '#e0a910'}}>attr</code></> location** (<code><Link to="/sdk/package/steeleagle_sdk/api/datatypes/common#class-location">Location</Link></code>) <text>&#8212;</text> target heading or global location to look at

**<><code style={{color: '#e0a910'}}>attr</code></> heading_mode** (<code>Optional[<Link to="/sdk/package/steeleagle_sdk/api/datatypes/control#class-headingmode">HeadingMode</Link>]</code>) <text>&#8212;</text> determines how the drone will orient
...
**<><code style={{color: '#e0a910'}}>attr</code></> pose** (<code><Link to="/sdk/package/steeleagle_sdk/api/datatypes/common#class-pose">Pose</Link></code>) <text>&#8212;</text> target pose

**<><code style={{color: '#e0a910'}}>attr</code></> pose_mode** (<code>Optional[<Link to="/sdk/package/steeleagle_sdk/api/datatypes/control#class-posemode">PoseMode</Link>]</code>) <text>&#8212;</text> specifies how to interpret the target pose
...
frame rates.
#### Attributes
**<><code style={{color: '#e0a910'}}>attr</code></> configurations** (<code>List[<Link to="/sdk/package/steeleagle_sdk/api/datatypes/control#class-imagingsensorconfiguration">ImagingSensorConfiguration</Link>]</code>) <text>&#8212;</text> list of configurations to be updated
