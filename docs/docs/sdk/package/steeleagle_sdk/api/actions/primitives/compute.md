...
_Type_: <code><Link to="/sdk/package/steeleagle_sdk/protocol/services/compute_service_pb2_grpc#class-computestub">ComputeStub</Link></code>
...
#### Attributes
**<><code style={{color: '#e0a910'}}>attr</code></> datasinks** (<code>List[<Link to="/sdk/package/steeleagle_sdk/api/datatypes/compute#class-datasinkinfo">DatasinkInfo</Link>]</code>) <text>&#8212;</text> name of target datasinks
