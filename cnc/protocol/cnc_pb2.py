...
_EXTRAS = _descriptor.Descriptor(
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_lower_bound', full_name='cnc.Extras._lower_bound',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_upper_bound', full_name='cnc.Extras._upper_bound',
...
_EXTRAS.oneofs_by_name['_lower_bound'].fields.append(
  _EXTRAS.fields_by_name['lower_bound'])
_EXTRAS.fields_by_name['lower_bound'].containing_oneof = _EXTRAS.oneofs_by_name['_lower_bound']
_EXTRAS.oneofs_by_name['_upper_bound'].fields.append(
  _EXTRAS.fields_by_name['upper_bound'])
_EXTRAS.fields_by_name['upper_bound'].containing_oneof = _EXTRAS.oneofs_by_name['_upper_bound']
