...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Configures the logger and starts all major modules."
    )
    parser.add_argument(
        "--test",
        type=str,
        help="run a test or set of tests in a directory (e.g. test/)",
    )
    parser.add_argument(
        "--config",
        type=str,
    ...
    parser.add_argument(
        "--internal",
        type=str,
        default=".internal.toml",
        help="override internal config file path (default: .internal.toml)",
    )
    parser.add_argument(
        "--law",
        type=str,
        default=".laws.toml",
        help="override law config file path (default: .laws.toml)",
    )
    parser.add_argument(
        "--headless",
        action="store_true",
        default=False,
        help="starts the kernel without a driver (default: False)",
    )
