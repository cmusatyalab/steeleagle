...
class Test_Law:
    ...
    async def test_payload_matcher(self, messages, swarm_controller, mission, kernel):
        ...
        requests = [
            ...
            Request(
                "Control.TakeOff",
                control_proto.TakeOffRequest(take_off_altitude=10.0),
                2,
                "internal",
            ),
            ...
            Request(
                "Control.TakeOff",
                control_proto.TakeOffRequest(take_off_altitude=5.0),
                2,
                "internal",
            ),
            ...
            Request(
                ...
                control_proto.SetGlobalPositionRequest(
                    location=common_proto.Location(latitude=10.0)
                ),
                2,
                "internal",
            ),
