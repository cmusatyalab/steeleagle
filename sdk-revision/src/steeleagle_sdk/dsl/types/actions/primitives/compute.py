...
class AddDatasinks(Action):
    ...
    async def execute(self) -> Response:
        ...
        return await runtime.COMPUTE.add_datasinks(**self.model_dump())
...
class SetDatasinks(Action):
    ...
    async def execute(self) -> Response:
        ...
        Returns:
            Response: response generated by the RPC call.
        """
        return await runtime.COMPUTE.set_datasinks(**self.model_dump())
...
class RemoveDatasinks(Action):
    ...
    async def execute(self) -> Response:
        ...
        Returns:
            Response: response generated by the RPC call.
        """
        return await runtime.COMPUTE.remove_datasinks(**self.model_dump())
